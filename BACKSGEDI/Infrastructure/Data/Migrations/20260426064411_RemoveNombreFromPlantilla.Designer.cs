...
namespace BACKSGEDI.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260426064411_RemoveNombreFromPlantilla")]
    partial class RemoveNombreFromPlantilla
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BACKSGEDI.Domain.Entities.DocumentoAcuerdo", b =>
                {
                    ...
                    b.HasOne("BACKSGEDI.Domain.Entities.Usuario", "AsesorExterno")
                        .WithMany()
                        .HasForeignKey("AsesorExternoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BACKSGEDI.Domain.Entities.Usuario", "AsesorInterno")
                        .WithMany()
                        .HasForeignKey("AsesorInternoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BACKSGEDI.Domain.Entities.Usuario", "Profesor")
                        .WithMany()
